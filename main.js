...
const catalogueFilms = {
    ...
    "masque - vendredi 13": { 
        answers: ["vendredi 13", "friday the 13th"], 
        id: "4488",
    ...
    "masque - le silence des agneaux": { 
        answers: ["le silence des agneaux", "the silence of the lambs"], 
        id: "274",
    ...
    "chapeau krugger": { 
        answers: ["freddy les griffes de la nuit", "les griffes de la nuit", "a nightmare on elm street"], 
        id: "377",
    ...
    "skate": { 
        answers: ["a girl walks home alone at night"], 
        id: "252171",
    ...
    "robe de chambre exorciste": { 
        answers: ["lexorciste", "the exorcist"], 
        id: "9552",
